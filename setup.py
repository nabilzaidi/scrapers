...
setup(
  ...
  packages = ['scrapers'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/nabilzaidi/scrapers/archive/0.1.tar.gz',    # I explain this later on
  keywords = ['SCRAPPING'],   # Keywords that define your package best
